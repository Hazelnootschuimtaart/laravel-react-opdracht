...
export default function FavouriteButtons(props) {
    ...
    const bookIsFavourite = true;

    const handleSubmitFavourite = (e) => {
        props.handleSubmitFavourite(e);
    };

    const handleDeleteFavourite = (e) => {
        props.handleDeleteFavourite(e);
    }

    return (
        <form className="pt-3" name={"favourite-book" + props.book.id} onSubmit={handleSubmitFavourite}>
            ...
            <PrimaryButton onClick={handleDeleteFavourite} method="delete">Cancel favourite</PrimaryButton>
        </form>
    )
}
